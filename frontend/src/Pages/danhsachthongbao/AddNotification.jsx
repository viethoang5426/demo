...
export default function AddNotification({setIsModalAdd}) {
  ...
  return (
    <EuiModal onClose={()=>setIsModalAdd(false)} style={{width:'700px'}}>
      <EuiModalHeader>
        <EuiModalHeaderTitle><p>Thêm mới thông báo</p></EuiModalHeaderTitle>
      </EuiModalHeader>
      <EuiModalBody>
        <EuiFlexGroup>
            <EuiFlexItem>
